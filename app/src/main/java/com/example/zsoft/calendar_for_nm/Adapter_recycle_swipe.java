...
public class Adapter_recycle_swipe extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private Context context;
     ...
     Adapter_recycle_swipe(Context context){
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {
        ...
        switch (viewType) {
            case TYPE_FULL:
                ...
                ((FullHolder)holder).swipeLayout.setShowMode(SwipeLayout.ShowMode.LayDown);
                ((FullHolder)holder).swipeLayout.addSwipeListener(new SimpleSwipeListener(){
                    @Override
    ...
    public class FullHolder extends RecyclerView.ViewHolder {
        ...
        FullHolder(View itemView) {
            ...
            cardView=itemView.findViewById(R.id.card_sw);
            textView=itemView.findViewById(R.id.textView12_sw);
            editText=itemView.findViewById(R.id.editText2_sw);
            checkBox= itemView.findViewById(R.id.checkBox2_sw);
            h=itemView.findViewById(R.id.h_sw);
            m=itemView.findViewById(R.id.m_sw);
            h2=itemView.findViewById(R.id.h2_sw);
            m2=itemView.findViewById(R.id.m2_sw);
